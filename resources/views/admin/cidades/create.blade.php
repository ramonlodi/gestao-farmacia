        ...
        <div class="card border-0 shadow-sm rounded-4 p-2">
            <div class="card-body p-4">
                <div class="d-flex align-items-center gap-3 mb-4">
                    ...
                    <div>
                        <h5 class="mb-0 fw-700">Nova Cidade</h5>
                        <p class="text-muted small mb-0">Cadastre uma cidade de atuação</p>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('admin.cidades.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="estado" class="form-control bg-light border-0" value="{{ old('estado') }}" maxlength="2" placeholder="SC" required>
                    </div>
