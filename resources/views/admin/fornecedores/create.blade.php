            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-center gap-3 mb-4">
                    <div style="width:44px;height:44px;background:#fefce8;border-radius:12px;display:flex;align-items:center;justify-content:center;">
                        <i class="bi bi-building-add" style="color:#ca8a04;"></i>
                    </div>
                    <div>
                        <h5 class="mb-0 fw-700">Novo Fornecedor</h5>
                        <p class="text-muted small mb-0">Cadastre um novo fornecedor</p>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('admin.fornecedores.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="razao_social" class="form-control bg-light border-0" value="{{ old('razao_social') }}" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-500 small">CNPJ</label>
                        <input type="text" name="cnpj" class="form-control bg-light border-0" value="{{ old('cnpj') }}" placeholder="00.000.000/0000-00" required>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
                            <label class="form-label fw-500 small">Contato</label>
                            <input type="text" name="contato" class="form-control bg-light border-0" value="{{ old('contato') }}">
                        </div>
                        <div class="col mb-3">
